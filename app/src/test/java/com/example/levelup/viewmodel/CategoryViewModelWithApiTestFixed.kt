...
class CategoryViewModelWithApiTestFixed {
    ...
    fun `loadCategories should update loading state on success`() = runTest {
        val testCategories = listOf(
            CategoryModel(id = 1, name = "Category 1", description = "Desc 1", icon = "icon1"),
            CategoryModel(id = 2, name = "Category 2", description = "Desc 2", icon = "icon2")
        )
    ...
    fun `categorias flow should return data from local repository`() = runTest {
        val testCategories = listOf(
            CategoryModel(id = 1, name = "Test Category", description = "Test Desc", icon = "testIcon")
        )
    ...
    fun `isLoading should handle Loading state`() = runTest {
        ...
        assertTrue(categoryViewModel.isLoading.value)
    }
}
